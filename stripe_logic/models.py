...
class Discount(models.Model):
    ...
    value = models.PositiveIntegerField(
        verbose_name='размер скидки', default=10,
...
class Tax(models.Model):
    ...
    name = models.CharField(max_length=64, verbose_name='наименование',)
    value = models.PositiveIntegerField(
        verbose_name='размер налога', default=10,
...
class Order(models.Model):
    ...
    status = models.CharField(
        ...
        max_length=3, default=PROCEEDED
    )
    discount = models.ForeignKey(
        Discount, blank=True, null=True,
        verbose_name='Скидка', on_delete=models.CASCADE
    )
    tax = models.ForeignKey(
        Tax, blank=True, null=True,
        verbose_name='Налог', on_delete=models.CASCADE
    )
...
class Item(models.Model):
    ...
    order = models.ForeignKey(
        Order, verbose_name='заказ', related_name='orderitems',
